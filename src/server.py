...
def metrics():
  ...
  flowAbout = about(url, token, cert, verify_ssl)
  ...
  generalFlow = getFlow(url, token, cert, verify_ssl)
  ...
  nifi_group = getProcessorFlow(url, token, cert, verify_ssl)
